...
const RESUME_IDS: ResumeId[] = ["en", "es", "ats"];

/** Interactive download cards + status dialog (client island). */
        ...
        renderItem={(resumeId) => {
          ...
          return (
            ...
            >
              ...
              <p className="mb-6 flex-1 text-sm text-muted">{t(`items.${resumeId}.description`)}</p>
        ...
        {dialog.open ? (
          <>
            <p className="text-muted">
              {dialog.status === "success" ? t("dialog.successBody") : t("dialog.errorBody")}
            </p>
